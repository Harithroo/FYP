    ...
    <div class="oinfraction_page">
        ...
        <div class="container">
            <div class="side_nav">
                ...
                <div class="button"><button class="oprint" onclick="Export('oinfractionspending')">Print List</button></div>
            </div>
            <div class="content">
                <?php
                    echo $oinfractionspending;
                ?>
                <!-- <div class="record">
                    <div class="recordl">
...
<footer class="footer">
    ...
    <script>
        function Export(oinfractionspending)
        {
            var conf = confirm("Export users to CSV?");
            if(conf == true)
            {
                window.open("export.php?table="+oinfractionspending+"", '_blank');
            }
        }
    </script>
</html>