...
imagepath="inputs/"+image+".jpg"
# imagepath="inputs/1.jpg"
# imagepath="inputs/2.jpg"
# imagepath="inputs/3.jpg"
# imagepath="inputs/4.jpg"
...
try:
    ...
    if not(type(numberplate) is int) and not(numberplate==-1):
        ...
        conn.inputSQL(final_plate,path)
        conn.sendemail(final_plate)
    else:
